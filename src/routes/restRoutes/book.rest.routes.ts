...
import { createBookRestController, deleteBookRestController, editBookRestController, getBookRestController } from "../../controller/restController/book.controller.rest";
...
bookRoutesRest.patch("/api/book/:id",verifyUser,uploadBook.any(), editBookRestController)
